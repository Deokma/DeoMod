...
public class logBeachChair extends HorizontalFacingBlock implements BlockEntityProvider, Waterloggable {

    public static final BooleanProperty WATERLOGGED = Properties.WATERLOGGED;

    public logBeachChair() {
    ...
    public VoxelShape getOutlineShape(BlockState state, BlockView view, BlockPos pos, ShapeContext ctx) {
        ...
        switch(dir) {
            ...
            case EAST:
            case WEST:
                return VoxelShapes.cuboid(0.1, 0.4, 0.1, 0.9, 0.5, 0.9);
            default:
