...
import static net.deokma.deomod.mixin.accessor.PlayerEntityAccessor.getLEFT_SHOULDER_ENTITY;
import static net.deokma.deomod.mixin.accessor.PlayerEntityAccessor.getRIGHT_SHOULDER_ENTITY;
...
public class PoseManagerEntity extends ArmorStandEntity {
    ...
    public PoseManagerEntity(Vec3d pos, Pose pose, ServerPlayerEntity player, ChairPosition position) {
        ...
        super(DeoMod.RAW_CHAIR_ENTITY_TYPE, player.getWorld());
