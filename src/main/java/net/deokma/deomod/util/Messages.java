...
import static net.deokma.deomod.error.PoseException.StateException;
import static net.deokma.deomod.error.PoseException.MidairException;
import static net.deokma.deomod.error.PoseException.SpectatorException;
import static net.deokma.deomod.error.PoseException.PoseDisabled;
import static net.deokma.deomod.error.PoseException.BlockOccupied;
